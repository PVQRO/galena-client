...
export default function ContributorsPage(){
    ...
    return (
            <div className="row contributors">
                <div className="row title-contributors"><h3 className="section-title"><b>CONTRIBUTORS</b></h3></div>
                <div className="row list-contributors">
                    ...
                    <Contributor image="images/carmen.png" name="Carmen Arquero Domínguez" position="Medicine" linkedin="https://www.linkedin.com/in/carmen-arquero-dominguez-b42282132/"/>
